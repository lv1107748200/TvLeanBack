...
package com.hr.tvleanbacklibrary.widget;
...
public abstract class ParallaxEffect {
    ...
    /**
     * Sets the list of {@link Parallax.PropertyMarkerValue}s, which represents the range of values that
     * source variables can take.
     *
     * @param markerValues A list of {@link Parallax.PropertyMarkerValue}s.
     * @see #performMapping(Parallax)
     */
    ...
    static final class IntEffect extends ParallaxEffect {
        ...
        Number calculateDirectValue(Parallax source) {
            ...
            Number currentValue = ((Parallax.IntProperty) mMarkerValues.get(0).getProperty()).get(source);
        ...
        float calculateFraction(Parallax source) {
            ...
            for (int i = 0; i <  mMarkerValues.size(); i++) {
                ...
                if (i == 0) {
                    ...
                    if (currentValue == Parallax.IntProperty.UNKNOWN_AFTER) {
                        ...
                        } else if (lastValue != Parallax.IntProperty.UNKNOWN_BEFORE) {
    ...
    static final class FloatEffect extends ParallaxEffect {
        ...
        Number calculateDirectValue(Parallax source) {
            ...
            float value1 = ((Parallax.FloatPropertyMarkerValue) mMarkerValues.get(0))
                    .getMarkerValue(source);
            float value2 = ((Parallax.FloatPropertyMarkerValue) mMarkerValues.get(1))
                    .getMarkerValue(source);
            if (value1 > value2) {
            ...
            Number currentValue = ((Parallax.FloatProperty) mMarkerValues.get(0).getProperty()).get(source);
        ...
        float calculateFraction(Parallax source) {
            ...
            // go through all markerValues, find first markerValue that current value is less than.
            for (int i = 0; i <  mMarkerValues.size(); i++) {
                Parallax.FloatPropertyMarkerValue k = (Parallax.FloatPropertyMarkerValue) mMarkerValues.get(i);
                int index = k.getProperty().getIndex();
                ...
                if (i == 0) {
                    ...
                    if (currentValue == Parallax.FloatProperty.UNKNOWN_AFTER) {
                        // Implies lastValue is less than lastMarkerValue and lastValue is not
                        ...
                        if (lastIndex == index) {
                            ...
                            fraction = (float) (lastMarkerValue - currentValue)
                                    / (lastMarkerValue - markerValue);
                        } else if (lastValue != Parallax.FloatProperty.UNKNOWN_BEFORE) {
                            // e.g. UIElement_1 at 300 scroll to UIElement_2 at 400, figure out when
                            // UIElement_1 is at markerValue=300,  markerValue of UIElement_2 by
                            // adding delta of values to markerValue of UIElement_2.
                            lastMarkerValue = lastMarkerValue + (currentValue - lastValue);
