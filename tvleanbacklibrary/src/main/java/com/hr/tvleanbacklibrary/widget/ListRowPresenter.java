...
import com.hr.tvleanbacklibrary.system.Settings;
import com.hr.tvleanbacklibrary.transition.TransitionHelper;
    ...
    public static class SelectItemViewHolderTask extends Presenter.ViewHolderTask {
        ...
        public void run(Presenter.ViewHolder holder) {
            if (holder instanceof ListRowPresenter.ViewHolder) {
                ...
                com.hr.tvleanbacklibrary.widget.ViewHolderTask task = null;
                if (mItemTask != null) {
                    task = new com.hr.tvleanbacklibrary.widget.ViewHolderTask() {
