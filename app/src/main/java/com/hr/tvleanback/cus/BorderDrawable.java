...
public class BorderDrawable extends Drawable {
    ...
    public void update(int mainColor, boolean showInner) {
        ...
        mPaint.setStrokeWidth(DisplayUtils.getDimen(R.dimen.dp_4));
//        mPaint.setMaskFilter(new BlurMaskFilter(0.5f, BlurMaskFilter.Blur.NORMAL));
